...
Gem::Specification.new do |s|
  s.name = "mogile_image_store"
  s.version = "0.0.3"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Mitsuhiro Shibuya"]
  s.date = "2013-04-12"
  s.description = "Rails plugin for using MogileFS as image storage"
  s.email = "m.shibuya@green-bell.jp"
  s.extra_rdoc_files = [
    "README.rdoc"
  ]
  s.files = [
  ...
  s.homepage = "http://git.dev.ist-corp.jp/mogile_image_store"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.25"
  s.summary = "Rails plugin for using MogileFS as image storage"
